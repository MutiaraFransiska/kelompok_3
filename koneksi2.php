...
class database{
    ...
    function tambahdata($nama_barang,$stok,$harga_beli,$harga_jual)
    {
    ...
    function updatedata($nama_barang,$stok,$harga_beli,$harga_jual,$id_barang)
    {
	    $query = mysqli_query($this->koneksi,"update tb_barang set nama_barang='$nama_barang',stok='$stok',harga_beli='$harga_beli',
